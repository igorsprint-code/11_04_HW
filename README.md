# Домашнее задание к занятию  «Очереди RabbitMQ» Дедяхин Игорь
...
Кластер с включенной политикой:
...
![screen](screenshots/3-4.png)


В consumer.py указываем адрес второй ноды, запускаем скрипт и получаем 5 сообщений отправленных на первую ноду.

![screen](screenshots/3-5.png)
